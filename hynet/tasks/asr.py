...
from hynet.asr.decoder.transformer_decoder import TransformerDecoder
from hynet.asr.encoder.transformer_encoder import TransformerEncoder
    ...
    def build_preprocess_fn(
        ...
        if args.use_preprocessor:
            retval = CommonPreprocessor_multi(
                ...
                g2p_type=args.g2p,
                text_name=["text_input", "text_output"],
            )
        else:
            retval = None
